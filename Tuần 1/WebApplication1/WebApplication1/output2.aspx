<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="output2.aspx.cs" Inherits="WebApplication1.output2" %>
    ...
    <form id="form1" runat="server">
        <div>
            <%
                ...
                CheckBoxList s = (CheckBoxList)PreviousPage.FindControl("language");
                string language = "";
                foreach (ListItem item in s.Items)
                {
                    if (item.Selected) language = language + item.Text + "  ";
                }
                string bacluong = Request.Form["luong"];
                string ngaycong = Request.Form["ngaycong"];
                string chucvu = Request.Form["list"];
                 int phucap = 0;
